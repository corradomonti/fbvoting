...
(function($, window, document) {
  ...
  FacebookAutocomplete = (function() {
        ...
        return function(response) {
          ...
          for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
            ...
            _results.push(friends.push({
              ...
              id: friend.id,
              name: friend.name,
              picture: _this.settings.showAvatars ? "https://graph.facebook.com/" + friend.id + "/picture?width=" + _this.settings.avatarSize + "&height=" + _this.settings.avatarSize : void 0
            }));
          }
          return _results;
        };
    ...
    FacebookAutocomplete.prototype.submit = function() {
      ...
      if (!this.settings.showAvatars) {
        selectedFriend.picture = "https://graph.facebook.com/" + selectedFriend.id + "/picture?width=" + this.settings.avatarSize + "&height=" + this.settings.avatarSize;
      }
